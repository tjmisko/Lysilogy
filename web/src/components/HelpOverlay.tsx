...
const GROUPS = [
  {
    ...
    commands: [
      ...
      ["Ctrl-d / Ctrl-u", "Page down / up (a PDF spread or half a text viewport)"],
      ["PageDown / PageUp", "Page down / up (a PDF spread or full text viewport)"],
      ["/", "Search the library or Glossary"],
