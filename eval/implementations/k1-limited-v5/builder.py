...
IMPLEMENTATION = ['scripts/truth/latex/' + name for name in ('archive.py', 'tex.py', 'parser.py', 'align.py', 'builder.py', 'annotations.py', 'object_annotations.py', 'bibliography_annotations.py', 'native_exports.py', 'tranche.py', 'tranche_visual.py', 'tranche_visual_only.py', 'tranche_numbered_math.py', 'panel.py', 'manual.py', 'release.py')] + ['examples/k1_index.rs', 'src/library.rs', 'src/store.rs', 'src/domain.rs', 'src/source_index.rs', 'src/source_index/cache.rs', 'src/source_index/native.rs', 'src/source_index/paragraphs.rs', 'src/source_index/ocr.rs', 'src/source_index/figures.rs', 'scripts/corpus/corpus.py', 'scripts/corpus/selection.json', 'Cargo.toml', 'Cargo.lock']
